...
public class ClsService /* extends Student */ {
	...
	public void ex1() {
		...
		// System.out.println( v4 ); // private 다른 클래스 불가능

		System.out.println(std.v1); // public
		// >> 전체에서 직접 접근 가능 public인 v1만 에러발생 X
	...
	public void ex2() {
		...
		// schoolName에 노란줄이 뜨는 이유(경고) >> 제대로 작성을 안 해서 나옴

		// *** static이 붙은 변수(필드)/메서드는 '클래스명.변수명'으로 작성해야 함 ***
		System.out.println(Student.schoolName);

		// ** static의 가장 큰 특징 : 객체를 만들지 않아도 클래스 이름으로
		// 값에 바로 접근이 가능하다. **
	...
	public void ex3() {
		...
		User u1 = new User();
		// 기본 생성자를 개발자가 만들지 않았다면 컴파일러가 자동으로 만들어줌
		...
		// 문제점 : u1이 참조하고 있는 User 객체와 u2가 참조하고 있는 User 객체의
		// 필드값이 모두 동일하다.
		// Why? 같은 생기본생성자로 User 객체를 생성하고 있기 때문에
		// 기본생성자에 작성된 코드가 똑같이 수행됨...

		System.out.println("-----------------------------");

		// 해결방법 1 : setter를 이용하여 새로운 값 재대입
	...
	public void ex4() {
		//매개변수 생성자 예제
		User u1 = new User(); 	// 기본 생성자 (생성자가 하나도 없는 경우 컴파일러가 만들어줌)
