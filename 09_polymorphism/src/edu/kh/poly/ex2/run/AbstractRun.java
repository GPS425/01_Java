...
import edu.kh.poly.ex2.model.service.JJMCalculator;
...
//		new AbstractService().ex1();
		...
		Calculator cal = new JJMCalculator();	// Calculator cal = new HGDCalculator(); 으로 바꾸면 바로 다시 사용 가능
		
		System.out.println("합 : " + cal.plus(20, 30));
		System.out.println("차 : " + cal.minus(20, 30));
		System.out.println("곱 : " + cal.multiple(20, 30));
		System.out.println("몫 : " + cal.divide(20, 3));
